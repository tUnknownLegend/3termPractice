...
\begin{frame}{Результаты расчетов}
	...
	\begin{columns}
		...
		\vspace*{-10mm}
		\begin{figure}[!htbp]
			\center{\includegraphics[width=1.2\textwidth, height=0.7\textheight]{res_static.png}}
...
\begin{frame}{Верификация}
	...
	\begin{columns}
		...
		\begin{figure}[!htbp]
			\center{\includegraphics[width=\textwidth, height=0.6\textheight]{check_func_2.png}}
			\caption{Проверочная функция}
		...
		\column{0.5\textwidth}
		\begin{figure}[!htbp]
			\center{\includegraphics[width=\textwidth, height=0.6\textheight]{res_check_func_2.png}}
...
\begin{frame}{Сравнение результатов при расширяющимся зазоре}
	\begin{columns}
		\column{0.5\textwidth}
		\begin{figure}[!htbp]
			\center{\includegraphics[width=1.1\textwidth, height=\textwidth]{res_pos.png}}
		...
		\column{0.5\textwidth}
		\begin{figure}[!htbp]
			\center{\includegraphics[width=1.1\textwidth, height=\textwidth]{zero_pos.png}}
...
\begin{frame}{Сравнение результатов при сужающимся зазоре}	
	\begin{columns}
		\column{0.5\textwidth}
		\begin{figure}[!htbp]
		\center{\includegraphics[width=1.2\textwidth, height=\textwidth]{res_static.png}}
		\caption{Распределение давления $h = -0.15 x + 0.001$~м}
		\label{res_static}
	\end{figure}
	...
	\column{0.5\textwidth}
	\begin{figure}[!htbp]
		\center{\includegraphics[width=1.2\textwidth, height=\textwidth]{zero_neg.png}}
		\caption{Распределение давления $h = -0.15 x + 0.001$~м, $p_{\text{в}} = p_{\text{н}}$}
		\label{zero_neg}
	\end{figure}
	\end{columns}
...
\begin{frame}{Аэроупругая модель}
	\vspace*{-9mm}
	\begin{figure}[!htbp]
		\center{\includegraphics[width=\textwidth, height=0.4\textheight]{pruzina-text.png}}
		\caption{Схема модели}
		\label{pruzina}
	\end{figure}	
